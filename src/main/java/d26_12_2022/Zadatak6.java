...
// dolare prema dole navedenoj konverziji. Metoda od parametara prima vrednost u eurima kao i valutu u kojoj je potrebno izvrsiti konverziju (RSD/USD/RUB) a vraca konvertovanu vrednost. U glavnom programu pozvati funkciju za neki od primera.
...
//1 EUR = 62.98 RUB
        ...
        System.out.println("Unesite valutu za konvertovanje:");
        String valuta = s.next();
    }
    public static double konvertuj(double eur, String valuta){
